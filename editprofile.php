                    ...
                    <div class="grid_3">
                        <div class="container">
                            ...
                            <form name="profile1" method="POST">
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="fname" id="validationDefault01" placeholder="First name" >
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="validationDefault02">Last name</label>
                                        <input type="text" class="form-control" name="lname" id="validationDefault02" placeholder="Last name" >
                                    </div>
                            ...
                            <option value="Other">Other</option>
                                ...
                                <div class="form-group col-md-8">
                                     ...
                                     <input type="text" class="form-control" name="edudescr" id="inputEmail" placeholder="edudescr" >
                            </div>
                        </div>
                        ...
                        <option value="Average">Average</option>
                            ...
                            <div class="form-group col-md-8 ">
                                ...
                                <select id="inputState" name="physicalstatus" class="form-control ">
                        ...
                        <div class="form-row ">
                            <div class="col-md-6 mb-3 ">
                                ...
                                <input type="number" name="height" class="form-control " id="validationDefault03 " placeholder="in CM " >
                            </div>
                            <div class="col-md-6 mb-3 ">
                                <label for="validationDefault04 ">Weight</label>
                                <input type="number " name="weight" class="form-control " id="validationDefault04 " placeholder=" " >
                            </div>
                        </div>
                        <div class="form-row ">
                            <div class="form-group col-md-4 ">
                        ...
                        <div class="form-row ">
                            <div class="col-md-6 mb-3 ">
                                ...
                                <input type="text " class="form-control " name="occupation" id="validationDefault03 " placeholder="City " >
                            </div>
                            <div class="col-md-6 mb-3 ">
                                <label for="validationDefault04 ">Annual Income</label>
                                <input type="number " class="form-control " name="income" id="validationDefault04 " placeholder="State " >
                            </div>
                        </div>
                        <form class="was-validated ">
                            <div class="mb-3 ">
                                <label for="validationTextarea ">Occupation Descr</label>
                                <textarea class="form-control is-invalid " name="occupationdescr" id="validationTextarea " placeholder="textarea " ></textarea>
                            ...
                            <div class="form-row ">
                                <div class="col-md-6 mb-3 ">
                                    ...
                                    <input type="text " class="form-control " name="fatheroccupation" id="validationDefault03 " placeholder="City " >
                                </div>
                                <div class="col-md-6 mb-3 ">
                                    <label for="validationDefault04 ">Mothers Occupation</label>
                                    <input type="text " class="form-control " name="motheroccupation" id="validationDefault04 " placeholder="State " >
                                </div>
                            </div>
                            <div class="form-row ">
                                <div class="form-group col-md-4 ">
                        ...
                        <option value="5 ">5</option>
                                ...
                                <form class="was-validated ">
                                    <div class="mb-3 ">
                                        ...
                                        <textarea class="form-control is-invalid " name="aboutme" id="validationTextarea " placeholder=" textarea " ></textarea>
                                        <div class="invalid-feedback ">
                                            Write about You
                                        </div>
                                    </div>
